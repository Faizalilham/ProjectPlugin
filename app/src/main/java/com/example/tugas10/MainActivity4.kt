...
class MainActivity4 : AppCompatActivity() {
    ...
    private fun updatedata() {
        button6.setOnClickListener {
            ...
            realm1.where(realm::class.java).equalTo("Judul",et4.text.toString()).findFirst().let {
    ...
    private fun deletedata() {
        button8.setOnClickListener {
            realm1.beginTransaction()
            realm1.where(realm::class.java).equalTo("Kalimat",et3.text.toString()).findFirst().let {
                it!!.deleteFromRealm()
            }
            realm1.commitTransaction()
            Toast.makeText(this,"Catatan Terhapus",Toast.LENGTH_SHORT).show()
            startActivity(Intent(this,MainActivity::class.java))
            finish()
        }
    }
    ...
    private fun back() {
        ...
        et4.setOnClickListener {
            Toast.makeText(this,"Judul tidak dapat diedit",Toast.LENGTH_SHORT).show()
        }
